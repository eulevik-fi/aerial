...
rem --- Installer (AerialScreenSaver.msi) ---
wix build --acceptEula true -arch x64 -d SourceDir=%~dp0out -o out\AerialScreenSaver.msi installer\Aerial.wxs
if errorlevel 1 exit /b 1
echo.
echo Installer complete: %~dp0out\AerialScreenSaver.msi
endlocal
